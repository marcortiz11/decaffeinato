...
//Rounding methods
void stochasticRounding(const double MAX, const double MIN, const double epsilon, double* p, const int elems);
void stochasticRounding(const double MAX, const double smallest, double *r, const int elems, const int zero);

void roundWithProb(const double MAX, const double MIN, const double epsilon, double* p, const int elems, const float PROB);
//void roundWithProb(const double MAX, const double smallest, double *r, const int elems, const int zero, const float PROB);

void roundToNearest(const double MAX, const double MIN, const double epsilon, double* p, const int elems);
void roundToNearest(double MAX, double smallest, double* r, int elems, int zero);

void roundMixed(const double MAX, const double MIN, const double epsilon, double* r, int elems, const float PROB, const float* seed, const int step, const int block);
...
template <typename Dtype>
void RoundFixedPoint(const CustomDataType& dataType, Dtype* p, int elems);

template <typename Dtype>
void RoundFloatingPoint(const CustomDataType& dataType, Dtype *p, const int elems);

template <typename Dtype>
void Round(const CustomDataType& dataType, Dtype* p, int elems);
...
// So they have to be pasted here temporarily.const
